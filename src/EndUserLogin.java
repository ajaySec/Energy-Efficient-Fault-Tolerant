...
EndUserLogin()
  {
	  jf = new JFrame("UserLogin::Energy Efficient Fault Tolerant Data Storage and Processing in Mobile Cloud");
	  c = jf.getContentPane();
	  c.setLayout(null);
	  c.setBackground(new Color(150,250,57));
  ...
  public void actionPerformed(ActionEvent e)
  {
	  ...
	  if(o == b1)
	  {
		  ...
		  try
		  {
			  ...
			  {
				  JOptionPane.showMessageDialog(null, "User is not Valid");
			  }
