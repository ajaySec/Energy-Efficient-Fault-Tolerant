...
public class ViewKoutn extends JFrame

{
	...
	ViewKoutn(){
		setTitle("K-OUT-N::Energy Efficient Fault Tolerant Data Storage and Processing in Mobile Cloud");
		c = getContentPane();
		...
		heading.addElement("Task Completed");
