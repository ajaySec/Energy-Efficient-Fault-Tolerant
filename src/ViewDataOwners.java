...
public class ViewDataOwners extends JFrame

{
	...
	ViewDataOwners(){
		setTitle("Cloud Data Owners::Energy Efficient Fault Tolerant Data Storage and Processing in Mobile Cloud");
		c = getContentPane();
		...
		heading.addElement("Task Assigned");
		heading.addElement("Completed Task");
		...
		try {
			...
			String query = "select * from koutn";//"SELECT * FROM CloudServer where order by rank DESC";
