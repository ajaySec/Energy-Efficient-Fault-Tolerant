...
public class ViewMobile extends JFrame

{
	...
	ViewMobile(){
		setTitle("Network Nodes Details::Energy Efficient Fault Tolerant Data Storage and Processing in Mobile Cloud");
		c = getContentPane();
		...
		heading.addElement("Energy Dropped");
		heading.addElement("Mobile Node");
		heading.addElement("K-OUT-N");
		...
		try {
			...
			String query = "select * from networkmanager";//"SELECT * FROM CloudServer where order by rank DESC";
