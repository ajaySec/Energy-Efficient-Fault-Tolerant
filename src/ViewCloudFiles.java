...
public class ViewCloudFiles extends JFrame

{
	...
	ViewCloudFiles(){
		setTitle("Cloud Attacker Details::Energy Efficient Fault Tolerant Data Storage and Processing in Mobile Cloud");
		c = getContentPane();
		...
		try {
			...
			String query = "select * from cloudfiles";//"SELECT * FROM CloudServer where order by rank DESC";
